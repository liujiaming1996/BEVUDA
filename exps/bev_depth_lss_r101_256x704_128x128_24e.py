...
class BEVDepthLightningModel(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # loss backward
        overall_loss = detection_loss + depth_loss + 0.1*(source_img_adv_loss + target_img_adv_loss) + 1*(source_bev_adv_loss + target_bev_adv_loss) + 0.1*(source_cam_adv_loss + target_cam_adv_loss) + 0.5*(source_vox_adv_loss + target_vox_adv_loss)
    ...
    def eval_step(self, batch, batch_idx, prefix: str):
        (sweep_imgs, mats, a, img_metas, gt_boxes, gt_labels, infos) = batch
    ...
    def val_dataloader(self):
        ...
        val_target_dataset = NuscMVDetDataset(
            ...
            classes=self.class_names,
            data_root=self.data_root,
            info_path='/home/notebook/data/group/liujiaming/cvpr2023/rongyu/BEV-UDA/vis_pkl/night_scene_1059_val.pkl',  # val_day
            # info_path='/home/notebook/data/group/liujiaming/cvpr2023/rongyu/BEV-UDA/data/nuScenes/nuscenes_12hz_infos_val_rainy.pkl',
            is_train=False,
            img_conf=self.img_conf,
            num_sweeps=self.num_sweeps,
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        default_root_dir='./outputs/bevuda-fog3-101-aligned')
